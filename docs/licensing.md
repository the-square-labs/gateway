...
| **Business** | Teams that need Git push-to-deploy, isolated Build Workers, external access to the internal registry, Secure Runtime isolation, structured logging, audit export, guided onboarding, and the planned application scaling/Compose capabilities | Unlimited | Priority |
