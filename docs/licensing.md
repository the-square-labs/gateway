...
Every official release includes the [Product Continuity MIT Grant](../CONTINUITY-MIT-GRANT.md) for covered Licensor-owned source. The grant is not triggered by a lack of releases, development, support, sales, renewals, announcements, or the unavailability of any website, repository, update service, or licensing service. Its automatic terms apply only if the relevant rights are held by a company that is finally dissolved and remains without a successor or assignee for 90 consecutive calendar days, or through an express voluntary MIT election by the current rights holder. Trademarks, commercial keys, separately licensed documentation and assets, and third-party components are outside the grant.
...
The [Product Continuity MIT Grant](../CONTINUITY-MIT-GRANT.md) is a present conditional grant for the covered source in a release. Its automatic terms apply only when the rights are held by a company that has been finally dissolved and remains without a successor or assignee for 90 days. Operational inactivity and service availability never start it.
