...
Gateway installs as a small Docker Compose stack containing the application, PostgreSQL, and Redis. Product configuration belongs to Gateway itself and is completed in the browser.
