export const CORE_TOKEN_SCOPES = [
  ...
  {
    value: "integrations:hosting:view",
    label: "View Hosting Integrations",
    desc: "View hosting accounts and connection status",
    group: "Integrations: Hosting",
  },
  {
    value: "integrations:hosting:manage",
    label: "Manage Hosting Integrations",
    desc: "Connect, configure and synchronize hosting accounts",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:resources:view",
    label: "View Hosting VMs",
    desc: "View provider inventory and associated Gateway nodes",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:resources:create",
    label: "Create Hosting VMs",
    desc: "Order provider VMs and install Gateway roles; may incur charges",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:resources:power",
    label: "Control VM Power",
    desc: "Start, shut down and reboot VMs; all hosted roles are affected",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:resources:resize",
    label: "Resize Hosting VMs",
    desc: "Change VM resources; may change provider charges",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:resources:delete",
    label: "Destroy Hosting VMs",
    desc: "Destroy provider VM data or cancel HOSTKEY rental",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:resources:recover",
    label: "Recover Hosted Nodes",
    desc: "Restart Gateway daemons or explicitly retry a failed installation",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:snapshots:view",
    label: "View VM Snapshots",
    desc: "View provider snapshots and snapshot folders without changing the VM",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:snapshots:create",
    label: "Create VM Snapshots",
    desc: "Create provider snapshots; storage may incur charges",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:snapshots:delete",
    label: "Delete VM Snapshots",
    desc: "Permanently delete provider snapshots",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:snapshots:restore",
    label: "Restore VM Snapshots",
    desc: "Replace current VM data with a snapshot",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:snapshots:folders:manage",
    label: "Organize VM Snapshots",
    desc: "Create snapshot folders and move snapshots between folders",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:billing:view",
    label: "View Hosting Finances",
    desc: "View account balance, charges, invoices and transactions",
    group: "Integrations: Hosting",
  },
  {
    value: "hosting:billing:topup",
    label: "Create Hosting Top-up Invoices",
    desc: "Create HOSTKEY deposit invoices; payment remains provider-hosted",
    group: "Integrations: Hosting",
  },
  {
