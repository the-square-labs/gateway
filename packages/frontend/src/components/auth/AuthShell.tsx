      ...
      >
        <div className="flex flex-col items-center gap-3">
          <div className="flex items-center gap-3">
            <img src="/android-chrome-192x192.png" alt="Square Gateway" className="h-10 w-10" />
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Square Gateway</h1>
          </div>
