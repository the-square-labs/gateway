ALTER TYPE "public"."node_type" ADD VALUE 'builder' BEFORE 'databases';--> statement-breakpoint
...
ALTER TABLE "relay_routes" ALTER COLUMN "source_id" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "docker_builds" ADD CONSTRAINT "docker_builds_superseded_by_build_id_docker_builds_id_fk" FOREIGN KEY ("superseded_by_build_id") REFERENCES "public"."docker_builds"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "docker_build_artifacts_repository_digest_platform_idx" ON "docker_build_artifacts" USING btree ("registry_repository","digest","platform");--> statement-breakpoint
...
CREATE INDEX "docker_build_secrets_binding_idx" ON "docker_build_secrets" USING btree ("source_binding_id");--> statement-breakpoint
...
CREATE INDEX "docker_source_bindings_desired_commit_idx" ON "docker_source_bindings" USING btree ("desired_commit_sha");--> statement-breakpoint
...
CREATE INDEX "docker_source_webhook_delivery_received_idx" ON "docker_source_webhook_deliveries" USING btree ("received_at");--> statement-breakpoint
