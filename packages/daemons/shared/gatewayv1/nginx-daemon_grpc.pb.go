...
func RegisterNodeEnrollmentServer(s grpc.ServiceRegistrar, srv NodeEnrollmentServer) {
	// If the following call pancis, it indicates UnimplementedNodeEnrollmentServer was
...
func RegisterMaintenanceAccessServer(s grpc.ServiceRegistrar, srv MaintenanceAccessServer) {
	// If the following call pancis, it indicates UnimplementedMaintenanceAccessServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterMigrationTransferServer(s grpc.ServiceRegistrar, srv MigrationTransferServer) {
	// If the following call pancis, it indicates UnimplementedMigrationTransferServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterLogStreamServer(s grpc.ServiceRegistrar, srv LogStreamServer) {
	// If the following call pancis, it indicates UnimplementedLogStreamServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
