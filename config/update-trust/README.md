...
`opencodex-signing-public-key.pem` is the independent trust anchor for signed
OpenCodex inference-core image manifests. Its private key exists only in the
protected OpenCodex release pipeline.
