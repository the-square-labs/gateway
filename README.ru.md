...
Каждый официальный релиз также содержит [условный Product Continuity MIT Grant](CONTINUITY-MIT-GRANT.md). Пауза разработки, прекращение поддержки или продаж, публичный анонс о прекращении продукта и недоступность сайта либо лицензионного сервера не запускают переход. Автоматические условия применяются только если права принадлежат компании, которая окончательно ликвидирована и в течение 90 дней остаётся без правопреемника или приобретателя прав, либо по отдельному добровольному решению текущего правообладателя.
