...
Исходный код Gateway принадлежит Alexandr Slavinschii, который ведёт проект под именем Square Labs, и доступен по [PolyForm Perimeter License 1.0.1](LICENSE.md). The Square Labs OÜ становится правообладателем только после регистрации в Эстонии и действительной письменной передачи соответствующих имущественных прав. Код можно использовать, изменять и распространять, в том числе внутри коммерческой компании. Ограничение касается предложения другим людям или организациям продукта, который позиционируется как замена Gateway. Ключ Personal, Business или Enterprise открывает возможности и лимиты соответствующего тарифа по [Paid Key Terms](COMMERCIAL-LICENSE.md); обычный ключ не даёт права выпускать OEM- или white-label-версию, перепродавать Gateway либо предлагать конкурирующий hosted-сервис.

Каждый официальный релиз также содержит [условный Product Continuity MIT Grant](CONTINUITY-MIT-GRANT.md). В нём нет отсчёта от даты релиза, а пауза разработки, прекращение поддержки или продаж, публичный анонс о прекращении продукта и недоступность сайта либо лицензионного сервера не запускают переход. До регистрации компании и письменной передачи прав автоматический переход отсутствует. После передачи прав The Square Labs OÜ условия MIT могут вступить в силу только после окончательной ликвидации компании и 90 дней без правопреемника либо по отдельному добровольному решению текущего правообладателя.
...
Copyright (c) 2021-2026 Alexandr Slavinschii, проект под именем [Square Labs](https://thesquarelabs.com)
